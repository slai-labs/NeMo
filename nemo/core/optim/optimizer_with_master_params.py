...
class MasterOptimizerWrapper(torch.optim.Optimizer):
    ...
    def __init__(self,
                 ...
                 contiguous_grad_buffers=False,
                 async_allreduce=False,
                 ):

        self.optimizer = optimizer
        assert self.optimizer, 'no optimizer is provided.'
        if contiguous_grad_buffers:
        ...
        self._contiguous_grad_buffers = contiguous_grad_buffers
        ...
        if self._contiguous_grad_buffers:
    ...
    def step(self, **kwargs):
        ...
        with torch.no_grad():
            torch.cuda.nvtx.range_push("copy_main_params_to_model_params")
