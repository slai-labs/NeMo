...
class ModelPT(LightningModule, Model):
    ...
    def setup_optimization(self, optim_config: Optional[Union[DictConfig, Dict]] = None):
        ...
        if optimizer_cls is not None:
            ...
            contiguous_grad_buffers = optimizer_args.pop('contiguous_grad_buffers', False)
            async_allreduce = optimizer_args.pop('async_allreduce', False)
            ...
            if use_master_param:
                ...
                optimizer = MasterOptimizerWrapper(
                    ...
                    contiguous_grad_buffers=contiguous_grad_buffers,
